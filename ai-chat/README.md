...
## Overview
 ...
 Chat allows users to ask natural language questions about quality data. It uses LiteLLM as an LLM proxy (supporting OpenAI-compatible models including local Ollama models), SQLPage to serve a web UI from SQL, and a React chat widget for the frontend.
...
spry sp spc --fs dev-src.auto --destroy-first --conf sqlpage/sqlpage.js --md spryfile.md
```
